...
public class VacationManagementSystemGui extends JFrame {
    ...
    public VacationManagementSystemGui() throws FileNotFoundException {
        initializeFields();
        initializeGraphics();
//        runVacationManagementSystem();
    ...
    // MODIFIES: this
    // EFFECTS: creates the JFrame window for the VacationManagementSystem, and add the buttons for functionalities
    private void initializeGraphics() {
        setTitle("Vacation Management System");
        ...
        addLogo();
        addMenuGraphic(); // TODO
//        addVacationPaneGraphic(); //TODO
//        addAttractionPaneGraphic(); //TODO

        setVisible(true);
    }

    private void addMenuGraphic() {
